...
<table class="easyui-datagrid" id="paperquestionList" title="题库列表" 
       data-options="singleSelect:false,collapsible:true,pagination:true,url:'/paper/question/list?paperId=${paperId}&type=${type}',method:'get',pageSize:30,toolbar:toolbar">
    <thead>
        <tr>
