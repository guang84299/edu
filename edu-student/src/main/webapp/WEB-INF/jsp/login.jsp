...
<body>
  <body style="background-color: #F3F3F3">
    <div id="loginbg" class="easyui-dialog" title="学生登录" data-options="modal:true,closable:false,draggable:false" style="width:400px;height:300px;padding:10px;">
    	...
    	//	var datas = JSON.stringify(user);
    		$.ajax({
				...
				success: function(data) { 
					...
					if(data.state == 200)
					{
						$.cookie('token-student', data.data); 
