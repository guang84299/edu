...
<body class="easyui-layout">
	...
	<div data-options="region:'north',border:false" style="height:60px; padding:5px; background:#F3F3F3"> 
		<span class="northTitle">学生端</span>
	    <span class="loginInfo">登录用户：${student.name}&nbsp;&nbsp;<span class="loginout">退出</span></span>
	</div>
    <div data-options="region:'west',title:'菜单',split:true" style="width:180px;">
    	<ul id="menu" class="easyui-tree" style="margin-top: 10px;margin-left: 5px;">
         	<li>
         		<span>科目管理</span>
         		<ul>
	         		<li data-options="attributes:{'url':'/student_tclass/toadd'}">新增科目</li>
	         		<li data-options="attributes:{'url':'/student_tclass/tolist'}">查询科目</li>
	         	</ul>
         	</li>
         	<li>
         		<span>作业管理</span>
         		<ul>
	         		<li data-options="attributes:{'url':'/paper/toanswer'}">做作业</li>
